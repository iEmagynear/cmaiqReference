...
export class AnalyticsComponent implements OnInit {
  ...
  SubjectPropertyValue: any;
  SubjectPIValue: any;
  SubjectExpencesValue: any;
  InvestmentReturn1to5 = 0;
  InvestmentReturn1to5TaxSavings = 0;
  InvestmentReturn1to5AHVA = 0;
  InvestmentReturn1to5TPP = 0;
  InvestmentReturn1to5CFBT = 0;

  InvestmentReturn1to10 = 0;
  InvestmentReturn1to10TaxSavings = 0;
  InvestmentReturn1to10AHVA = 0;
  InvestmentReturn1to10TPP = 0;
  InvestmentReturn1to10CFBT = 0;

  InvestmentReturn1to30 = 0;
  InvestmentReturn1to30TaxSavings = 0;
  InvestmentReturn1to30AHVA = 0;
  InvestmentReturn1to30TPP = 0;
  InvestmentReturn1to30CFBT = 0;
  HomeEquity = [];
  dic25: any;
  dic30: any;
  ...
  constructor(private sharedMlsService: SharedMlsService,private converterpipe: ConvertPipe,private _decimalPipe: DecimalPipe,
    ...
    calculateAveragePropertyValue(){
      ...
      this.SubjectPropertyValue = this.averagePropertyValue + parseFloat(this.chartdata.investment.Improvements);
    }
    ...
    generateChart(dic9){
      ...
      for (let index = 0; index < 30; index++) {
        ...
        (this.TotalPrincipalPayments).push(this.convertTONumber( Math.round(sum1+sum1S),'1.0-0'));
      ...
      /* console.log(this.TaxSavings);
      console.log(this.AnnualHomeValueAppreciation);
      console.log(this.TotalPrincipalPayments);
      console.log(this.cashFlowBeforeTaxes); */
      
      this.SubjectPIValue = (this.firstMortgageInterest[0] + this.secondMortgageInterest[0] + this.firstMortgagePrincipal[0] + this.secondMortgagePrincipal[0])/12;
      
      this.SubjectExpencesValue =  (this.TotalOperatingExpense[0])/12;

      for (let newIndex = 0; newIndex < 5; newIndex++) {

        /* console.log(this.cashFlowBeforeTaxes[newIndex]); */
        
        this.InvestmentReturn1to5TaxSavings	= this.InvestmentReturn1to5TaxSavings + this.TaxSavings[newIndex];

        this.InvestmentReturn1to5AHVA	= this.InvestmentReturn1to5AHVA + this.AnnualHomeValueAppreciation[newIndex];
        
        this.InvestmentReturn1to5TPP	= this.InvestmentReturn1to5TPP + this.TotalPrincipalPayments[newIndex];

        this.InvestmentReturn1to5CFBT	= this.InvestmentReturn1to5CFBT + this.cashFlowBeforeTaxes[newIndex];
        
      }

      this.InvestmentReturn1to5 = this.InvestmentReturn1to5TaxSavings + this.InvestmentReturn1to5AHVA + this.InvestmentReturn1to5TPP + this.InvestmentReturn1to5CFBT;

      /* console.log(this.InvestmentReturn1to5CFBT);
      console.log(this.InvestmentReturn1to5AHVA); */
      //console.log(this.InvestmentReturn1to5CFBT);
      //console.log(this.InvestmentReturn1to5CFBT);


      for (let newIndex = 0; newIndex < 10; newIndex++) {

        //console.log(this.cashFlowBeforeTaxes[newIndex]);

        this.InvestmentReturn1to10TaxSavings	= this.InvestmentReturn1to10TaxSavings + this.TaxSavings[newIndex];

        this.InvestmentReturn1to10AHVA	= this.InvestmentReturn1to10AHVA + this.AnnualHomeValueAppreciation[newIndex];
        
        this.InvestmentReturn1to10TPP	= this.InvestmentReturn1to10TPP + this.TotalPrincipalPayments[newIndex];

        this.InvestmentReturn1to10CFBT	= this.InvestmentReturn1to10CFBT + this.cashFlowBeforeTaxes[newIndex];
        
      }

      /* console.log(this.InvestmentReturn1to10TaxSavings);
      console.log(this.InvestmentReturn1to10AHVA);
      console.log(this.InvestmentReturn1to10TPP);
      console.log(this.InvestmentReturn1to10CFBT); */

      this.InvestmentReturn1to10 = this.InvestmentReturn1to10TaxSavings + this.InvestmentReturn1to10AHVA + this.InvestmentReturn1to10TPP + this.InvestmentReturn1to10CFBT;

      //console.log(this.InvestmentReturn1to10);
      
      for (let newIndex = 0; newIndex < 30; newIndex++) {

        this.InvestmentReturn1to30TaxSavings	= this.InvestmentReturn1to30TaxSavings + this.TaxSavings[newIndex];

        this.InvestmentReturn1to30AHVA	= this.InvestmentReturn1to30AHVA + this.AnnualHomeValueAppreciation[newIndex];
        
        this.InvestmentReturn1to30TPP	= this.InvestmentReturn1to30TPP + this.TotalPrincipalPayments[newIndex];

        this.InvestmentReturn1to30CFBT	= this.InvestmentReturn1to30CFBT + this.cashFlowBeforeTaxes[newIndex];
        
      }

      this.InvestmentReturn1to30 = this.InvestmentReturn1to30TaxSavings + this.InvestmentReturn1to30AHVA + this.InvestmentReturn1to30TPP + this.InvestmentReturn1to30CFBT;
