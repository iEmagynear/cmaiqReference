  ...
  constructor(private sharedMlsService: SharedMlsService,private converterpipe: ConvertPipe,private _decimalPipe: DecimalPipe,
    ...
    generateChart(dic9){
     ...
     /* console.log(this.AnnualHomeValueAppreciation);
      ...
      this.SubjectPIValue = this.firstMortgageInterest[0] + this.secondMortgageInterest[0] + this.firstMortgagePrincipal[0] + this.secondMortgagePrincipal[0];
      
      this.SubjectExpencesValue =  this.TotalOperatingExpense[0];
      ...
      //console.log(this.TotalPrincipalPayments[4]);
      //console.log(this.AnnualHomeValueAppreciation[4]);
