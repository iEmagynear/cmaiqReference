...
@Component({
  selector: 'app-dialog-property-popup',
  templateUrl: './dialog-property-popup.component.html',
  styleUrls: ['./dialog-property-popup.component.scss'],
...
export class DialogPropertyPopupComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,public translate: TranslateService, private formBuilder: FormBuilder,
  ...
  addPropertySub() {
    ...
    this.api.addProperty(body).subscribe((dataResponse) => {
      ...
      //console.log(this.addProperty.value.client);
      //this.client_id =
